        ...
        <div class="side-menu bg-dark">
            <div class="sidebar ">
                <ui class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="/users" class="nav-link main-fg-color active">
                                                ...
                                                <form action="/addUser" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="first_name" type="text" class="form-control" placeholder="First Name" id="first-name">
                                                            </div>
                                                        </div>
                                                        <div class="col">
                                                            <div class="form-group">
                                                                <label for="last-name">Last Name</label>
                                                                <input name="last_name" type="text" class="form-control" placeholder="Last Name" id="last-name">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    {{-- <div class="form-group">
                                                        ...
                                                        <select name="gender" class="form-control" id="gender">
                                                          ...
                                                          <option>Rather not tell</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="phoneNo">Phone No</label>
                                                        <input name="phoneNo" type="tel" class="form-control" placeholder="XXXX-XXXXXXX" id="phoneNo" pattern="[0-9]{4}-[0-9]{7}">
                                                    </div> --}}
                                        ...
                                        @foreach($userInfo as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="card-body">
                                                        <div class="card-header ">
                                                            <a href="#" type="button" data-toggle="modal" data-target="#update-user" class="btn btn-dark btn-edit">Edit</a>
                                                            <a href="/deleteUser/{{$user->user_id}}" class="btn btn-danger btn-delete">Delete</a>
                                                        </div>
                                                    ...
                                                    {{-- <a href="/editUser/{{$user->user_id}}" class="btn btn-primary ">Edit</a> --}}
                                                </td>
                                            </tr>
                                        @endforeach
                                        {{-- <tr>
